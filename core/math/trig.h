...
attr_core_api f32 f32_sin( f32 angle );
/// @brief Calculate cosine of x.
/// @param angle Value to get cosine of.
/// @return Cosine of angle.
/// @see #sine_cosine() if both sine and cosine of x are needed.
attr_core_api f32 f32_cos( f32 angle );
...
attr_core_api void f32_sincos( f32 angle, f32* out_sine, f32* out_cosine );
...
attr_always_inline
attr_header f32 f32_tan( f32 angle ) {
    f32 sine, cosine;
...
attr_always_inline
attr_header f32 f32_acos( f32 x ) {
